...
namespace MaxSu.Framework.Common.Chinese
{
    ...
    {
        public string GetPinYinFirstLetter(string chineseWords)
        {
            ...
            {
                array = Encoding.Default.GetBytes(chineseWords[i].ToString());

                //Ј«ЇЇ„÷
                if (array[0] < 176)
                {
                    return_py += chineseWords[i];
                }
                    //“їЉґЇЇ„÷
                else if (array[0] >= 176 && array[0] <= 215)
                {
                    if (chineseWords[i].ToString().CompareTo("‘—") >= 0)
                        return_py += "z";
                    else if (chineseWords[i].ToString().CompareTo("—є") >= 0)
                        return_py += "y";
                    else if (chineseWords[i].ToString().CompareTo("ќф") >= 0)
                        return_py += "x";
                    else if (chineseWords[i].ToString().CompareTo("Ќџ") >= 0)
                        return_py += "w";
                    else if (chineseWords[i].ToString().CompareTo("Ћъ") >= 0)
                        return_py += "t";
                    else if (chineseWords[i].ToString().CompareTo("»ц") >= 0)
                        return_py += "s";
                    else if (chineseWords[i].ToString().CompareTo("»ї") >= 0)
                        return_py += "r";
                    else if (chineseWords[i].ToString().CompareTo("∆Џ") >= 0)
                        return_py += "q";
                    else if (chineseWords[i].ToString().CompareTo("≈Њ") >= 0)
                        return_py += "p";
                    else if (chineseWords[i].ToString().CompareTo("≈ґ") >= 0)
                        return_py += "o";
                    else if (chineseWords[i].ToString().CompareTo("ƒ√") >= 0)
                        return_py += "n";
                    else if (chineseWords[i].ToString().CompareTo("¬и") >= 0)
                        return_py += "m";
                    else if (chineseWords[i].ToString().CompareTo("јђ") >= 0)
                        return_py += "l";
                    else if (chineseWords[i].ToString().CompareTo("њ¶") >= 0)
                        return_py += "k";
                    else if (chineseWords[i].ToString().CompareTo("їч") >= 0)
                        return_py += "j";
                    else if (chineseWords[i].ToString().CompareTo("єю") >= 0)
                        return_py += "h";
                    else if (chineseWords[i].ToString().CompareTo("ЄЅ") >= 0)
                        return_py += "g";
                    else if (chineseWords[i].ToString().CompareTo("ЈҐ") >= 0)
                        return_py += "f";
                    else if (chineseWords[i].ToString().CompareTo("ґк") >= 0)
                        return_py += "e";
                    else if (chineseWords[i].ToString().CompareTo("іо") >= 0)
                        return_py += "d";
                    else if (chineseWords[i].ToString().CompareTo("≤Ѕ") >= 0)
                        return_py += "c";
                    else if (chineseWords[i].ToString().CompareTo("∞≈") >= 0)
                        return_py += "b";
                    else if (chineseWords[i].ToString().CompareTo("∞°") >= 0)
                        return_py += "a";
                }
                ...
                {
                    return_py += ls_second_eng.Substring(ls_second_ch.IndexOf(chineseWords[i].ToString(), 0), 1);
                }
            }
        ...
        //ґ®“е∆і“ф«ш±а¬л э„й
        private static readonly int[] getValue = new[]
        {
        ...
        //ґ®“е∆і“ф э„й
        private static readonly string[] getName = new[]
        {
        ...
        /// <returns>„™їїЇуµƒ∆і“ф„÷ЈыіЃ</returns>
        public string ConvertToPinyin(string Chstr)
        {
            ...
            {
                //»зєы д»лµƒ «ЇЇ„÷
                if (RegexDao.IsChineseCh(mChar[j].ToString()))
                {
