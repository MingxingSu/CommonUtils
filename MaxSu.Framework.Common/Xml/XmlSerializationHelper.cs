...
namespace MaxSu.Framework.Common.Xml
{
    ...
    {
        /// <summary>
        ///     Deserializes an object (type indicated by <typeparamref name="T" />) loaded from the specified
        ///     <paramref
        ///         name="location" />
        ///     .
        /// </summary>
        ...
        /// <summary>
        ///     Serializes the <paramref name="target" /> object into xml and then saves it into the file specified by
        ///     <paramref
        ///         name="location" />
        ///     .
        /// </summary>
