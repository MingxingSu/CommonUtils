...
//-------------------------------------------
    public class Segment
    {
        ...
        private string m_DicPath = HttpContext.Current.Server.MapPath("bin/ShootSeg/sDict.dic");
        private double m_EventTime;
        private string m_NoisePath = HttpContext.Current.Server.MapPath("bin/ShootSeg/sNoise.dic");
        private string m_NumberPath = HttpContext.Current.Server.MapPath("bin/ShootSeg/sNumber.dic");
        private string m_PrefixPath = HttpContext.Current.Server.MapPath("bin/ShootSeg/sPrefix.dic");
        ...
        private string m_WordPath = HttpContext.Current.Server.MapPath("bin/ShootSeg/sWord.dic");
        ...
        {
            get { return m_NoisePath; }
            set { m_NoisePath = value; }
        }
        ...
        {
            get { return m_NumberPath; }
            set { m_NumberPath = value; }
        }
        ...
        {
            get { return m_WordPath; }
            set { m_WordPath = value; }
        }
        ...
        {
            get { return m_PrefixPath; }
            set { m_PrefixPath = value; }
        }
        ...
        public string Separator
        {
            ...
            set { if (value != "" && value != null) m_Separator = value; }
        }
